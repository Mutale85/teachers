...
if (isset($_POST['firstname'])) {
	...
	if($execute){ 
                            ...
                            <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                                            ...
                                            <tr>
                                                <td style="padding:0 35px;">
                                                    ...
                                                    <div style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                        <h2 class="title2">Thank you for subscribing to osabox.co</h2>
                                ...
                                <tr>
                                    <td style="text-align:center;">
                                        ...
                                        <p>With Osabox, you create and manage projects, generate payroll for your employees, issue invoices and receipts to your clients and more...</p>
		...
		$mail-> Subject = "We appreciate your registration";
		$mail->isHTML(TRUE);
		// $mail->SMTPDebug = 2;
		$mail->Body = $message;
		if($mail->send()){
