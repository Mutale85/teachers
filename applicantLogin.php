	        ...
	        <form class="form-horizontal" id="validateForm" method="post">
	            ...
	            <fieldset>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-12">
	                        <input id="email" name="email" type="text" autocomplete="off" placeholder="NRC Number" class="form-control input-md" required>
	                    </div>
	                </div>
	                ...
	                <p>Forgot Password? <a href="forgottenPassword">Click Here</a></p>
	            </fieldset>
	        </form>   
	    </div>
	</div>
